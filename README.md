...
**UTM Elementor** — это WordPress плагин, разработанный для сохранения UTM-меток и кликовых идентификаторов в cookies посетителя (First touch и Last touch) и их последующей удобной передачи в формы Elementor Pro.
...
2. Активируйте плагин ** UTM Elementor** в разделе "Плагины" WordPress.
3. Перейдите в меню **Настройки → UTM Elementor**.
